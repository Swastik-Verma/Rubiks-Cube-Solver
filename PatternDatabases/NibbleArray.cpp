...
//Get pointer to underlying array (because we will build the nibble array only once then using this function we will load that nibble array inspite of building it again and again whenever we need it).
